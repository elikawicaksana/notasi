<aside id="top-bar-sidebar" class="fixed top-0 left-0 z-40 w-64 h-full transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-form-dark border-e border-default">
        ...
        <ul class="space-y-2 font-medium">
            <li>
                <a href="dashboard-student.php" class="flex items-center px-2 py-1.5 text-body rounded-base hover:bg-neutral-tertiary hover:text-[#708238] group">
            ...
            <li>
                ...
                <ul id="dropdown-example" class="hidden py-2 space-y-2">
                    <li>
                        <a href="student-complete-course.php" class="pl-10 flex items-center px-2 py-1.5 text-body rounded-base hover:bg-neutral-tertiary hover:text-[#708238]">Complete</a>
                    </li>
                    <li>
                        <a href="student-ongoing-course.php" class="pl-10 flex items-center px-2 py-1.5 text-body rounded-base hover:bg-neutral-tertiary hover:text-[#708238]">Ongoing</a>
                    </li>
                </ul>
            </li>
            <li>

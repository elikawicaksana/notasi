                ...
                <div class="relative overflow-hidden w-full bg-neutral-primary-soft shadow-xs rounded-base border border-default">
                    <div class="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0 p-4 border-b border-default-medium">
                        <div class="w-full md:w-auto">
                            <h2 class="text-2xl font-semibold text-heading">Admins List</h2>
                                ...
                                <tr class="bg-neutral-primary-soft border-b border-default hover:bg-neutral-secondary-medium transition-colors duration-200">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <?php 
                                            ...
                                            if($idUser == $myId){
                                                echo "<span class='font-medium text-gray-500 cursor-not-allowed' title='You cannot delete your own account'>Delete</span>";
                                            }else{
                                                echo "<button type='button' id='btnDel' class='font-medium text-fg-danger hover:text-danger hover:underline transition-colors' data-id='".$idUser."'>Delete</button>";
                                            } 
                                        ?>
                                    </td>
                                </tr>

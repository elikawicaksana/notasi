...
<head>
    ...
    <title>Notasi | My Completed Courses</title>
    ...
    <?php
        ...
        $queryTotal = mysqli_query($conn, "SELECT COUNT(*) as total FROM db_notasi.tb_enrollments WHERE id_user = '$id_user' AND is_completed = 1");
        ...
        $sql = "SELECT 
                ...
                WHERE e.id_user = '$id_user' AND e.is_completed = 1
            ...
            <div class="w-full mb-24"> 
               <div class="w-full mb-24">
                    <div class="flex justify-between items-center mb-6">
                        <div>
                            <h2 class="text-2xl font-bold text-white">My Completed Courses</h2>
                            <p class="text-gray-400 text-sm mt-1">Access your certificates and review course materials.</p>
                        </div>
                    </div>
                    <?php
                                ...
                                <div class="bg-[#111827] rounded-xl overflow-hidden shadow-lg border border-gray-800 flex flex-col h-full hover:border-gray-600 transition-all">
                                    <div class="relative h-48 overflow-hidden group">
                                        ...
                                        <div class="absolute top-3 right-3">
                                            <span class="bg-[#006D4C] text-white text-[10px] font-bold px-2 py-1 rounded-full shadow-md">
                                    ...
                                    <div class="p-5 flex flex-col flex-grow">
                                        ...
                                        <div class="mt-auto pt-4 border-t border-gray-800">
                                            <p class="text-xs text-gray-500 mb-3">
                                                Finished on: <span class="text-gray-300"><?php echo date("d M Y", strtotime($row['completed_at'])); ?></span>
                                            </p>
                                            <div class="grid grid-cols-2 gap-2">
                                                <a href="certificate.php?id_enroll=<?php echo $row['id_enroll']; ?>" class="flex items-center justify-center px-3 py-2 bg-[#D4AF37] hover:bg-[#b5952f] text-black rounded-md transition text-sm font-bold" target="_blank">
                                                    <i class="fa-solid fa-certificate mr-1"></i> Certificate
                                                </a>
                                                <a href="course-learning.php?id_course=<?php echo $row['id_course']; ?>" class="flex items-center justify-center px-3 py-2 bg-gray-700 hover:bg-gray-600 text-white rounded-md transition text-sm font-medium" target="_blank">
                                                    <i class="fa-solid fa-rotate-left mr-1"></i> Revisit
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <?php 
                        ...
                        <div class="flex flex-col items-center justify-center p-16 text-gray-500 bg-[#111827] rounded-xl border border-dashed border-gray-700">
                            <i class="fa-solid fa-graduation-cap text-4xl mb-4 text-gray-600"></i>
                            <p class="text-lg font-medium text-gray-400">You haven\'t completed any courses yet.</p>
